  ...
  return (
    <main className="workspace-page">
      ...
      <div className="workspace-settings-grid">
        ...
        <section className="workspace-panel workspace-settings-card"><ExternalLink size={22} /><div><h2>90 秒路演舞台</h2><p>双手机同步展示林然邀请小雨负责布丁复诊的完整过程。</p></div><Link className="workspace-secondary-action" to="/demo">打开演示舞台 <ExternalLink size={16} /></Link></section>
      </div>
    </main>
  )
}
